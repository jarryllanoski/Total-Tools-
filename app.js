...
// ============================================================
// QUÉ HACE: Todo el comportamiento de la app:
//   - Estado (S) y guardado local/nube
//   - Renderizado de tarjetas y filtros
//   - Formularios (agregar/editar envíos)
//   - Configuración, etiquetas, couriers
//   - QR, Excel, WhatsApp, impresión
// CUÁNDO EDITAR:
//   - Nueva función → agrégala aquí
//   - Cambiar comportamiento de botones → busca la función
//   - Cambiar textos de mensajes WhatsApp → busca msgTemplates
// ============================================================
