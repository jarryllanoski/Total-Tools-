// ============================================================
// firebase.js — Conexión con Firebase Firestore via REST API
// ============================================================
// QUÉ HACE: Maneja toda la comunicación con Firebase.
// CUÁNDO EDITAR: Solo si cambias el proyecto Firebase,
//   credenciales, o la estructura de colecciones.
// ============================================================
...
(function(){
  ...
  // ── Quitar imágenes base64 (muy pesadas para Firestore) ───────────
  ...
  window._fbListen = () => {
    setInterval(async()=>{
      try{
        ...
        if(remoteTs>(window._S_TS||0)+3000){
          const remote=await window._fbLoad();
          if(remote&&window._mergeRemote) window._mergeRemote(remote);
        }
      }catch(e){}
    },5000);
  };
