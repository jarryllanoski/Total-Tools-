...
| `webhook.test.js` | La única puerta pública del sistema. Firmamos solo el cuerpo durante días —es sobre `momento.cuerpo`, y el crudo— y sin ventana de tiempo cualquiera puede reenviar una llamada grabada para siempre |
