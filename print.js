...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .header h1 { font-size:14pt; font-weight:900; letter-spacing:2px; }
  .header p  { font-size:9pt; color:#555; margin-top:2px; }
  .grid { display:grid; grid-template-columns:repeat(2,1fr); gap:6mm; }
  .card { border:2px solid #000; border-radius:6px; padding:4mm; page-break-inside:avoid; background:#fff; }
  .card-top { display:flex; justify-content:space-between; align-items:flex-start; gap:4mm; margin-bottom:3mm; }
  .remitente { flex:1; }
  .rem-label { font-size:7pt; font-weight:700; color:#888; letter-spacing:1px; text-transform:uppercase; margin-bottom:1mm; }
  .rem-name  { font-size:9pt; font-weight:700; }
  .rem-sub   { font-size:8pt; color:#555; }
  .qr-box    { text-align:center; flex-shrink:0; }
  .qr-box img { display:block; }
  .qr-label  { font-size:7pt; color:#555; margin-top:1mm; text-align:center; }
  .divider   { border-top:1px dashed #999; margin:2mm 0; }
  .destinatario { }
  .dest-label { font-size:7pt; font-weight:700; color:#888; letter-spacing:1px; text-transform:uppercase; margin-bottom:1mm; }
  .dest-name  { font-size:13pt; font-weight:900; margin-bottom:1mm; line-height:1.2; }
  .dest-phone { font-size:10pt; font-weight:700; color:#000; margin-bottom:1mm; }
  .dest-addr  { font-size:8pt; color:#333; margin-bottom:1mm; line-height:1.4; }
  .dest-ref   { font-size:8pt; color:#555; margin-bottom:1mm; }
  .agencia    { font-size:8pt; color:#333; margin-bottom:1mm; }
  .notes      { font-size:7pt; color:#777; font-style:italic; margin-top:1mm; }
  .card-footer { display:flex; justify-content:space-between; align-items:center; margin-top:3mm; padding-top:2mm; border-top:1px solid #ddd; }
  .courier { font-size:8pt; font-weight:700; background:#f3f4f6; padding:1mm 2mm; border-radius:3px; }
  .fecha   { font-size:8pt; color:#555; }
  .codigo  { font-size:9pt; font-weight:900; color:#000; letter-spacing:1px; }
  @media print {
    body { padding:5mm; }
    .grid { gap:4mm; }
